...
def define_elementos_menu():
    menu_image = pygame.image.load("img/geral/tela_menu_personagens_2.jpg")
...
def rederizacao_textos(font_menu):
    ...
    player_text_2 = font_menu.render("Player 2", True, (255, 255, 255))
    player_text_2_rect = shielder_text.get_rect()
    player_text_2_rect.center = (820, 700)
    
    return warrior_text, warrior_text_rect, shielder_text, shielder_text_rect, berserker_text, berserker_text_rect, player_text_2, player_text_2_rect
